...
// This file is entirely thanks to François Romain
...
const controlPoint = (lineCalc: typeof line, smooth: number) => (current: Point, previous: Point, next: Point, reverse?: boolean) => {
...
const bezierCommand = (controlPointCalc: Function) => (point: Point, i: number, a: Point[]) => {
  // start control point
...
export const svgPath = (points: Point[], command: typeof bezierCommandCalc) => {
